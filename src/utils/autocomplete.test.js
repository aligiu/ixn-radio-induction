import { stripHtmlTags, addTagFreeContentAndSecret, removeNonAlphanumeric, getSurroundingText } from './autocomplete';
...
describe('autocomplete.js functions', () => {
  ...
  describe('addTagFreeContentAndSecret', () => {
    it('should add tagFreeContent and tagFreeSecret to each item', () => {
      ...
      const expected = [
        { content: '<p>Hello</p>', secret: '<p>World</p>', tagFreeContent: 'Hello', tagFreeSecret: 'World' },
        { content: '<b>Test</b>', secret: '<i>Secret</i>', tagFreeContent: 'Test', tagFreeSecret: 'Secret' },
      ];
